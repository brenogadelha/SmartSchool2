...
{
	public class DisciplinaControllerTestes : TesteApi
	{
		private readonly IUnidadeDeTrabalho _contextos;
		private readonly IDisciplinaServico _disciplinaServico;

		private readonly DisciplinaController _disciplinaController;
		public DisciplinaControllerTestes()
		{
			...
			this._disciplinaController = new DisciplinaController(this._disciplinaServico);
		}
		...
		public void DeveCriarDisciplinaObterExcluirVerificar()
		{
			...
			this._disciplinaController.CriarDisciplina(disciplinaDto);
			...
			var disciplinaObtidaPorId = this._disciplinaController.ObterPorId(disciplinaObtidaPorNome.ID).Value as ObterDisciplinaDto;
			...
			this._disciplinaController.AlterarDisciplina(disciplinaObtidaPorId.ID, disciplinaDtoAlteracao);

			//obtém a Disciplina alterado do banco de dados
			var disciplinaDtoAlteradoVindoDoBanco = this._disciplinaController.ObterPorId(disciplinaObtidaPorNome.ID).Value as ObterDisciplinaDto;
			...
			//Deleta Disciplina
			this._disciplinaController.ExcluirDisciplina(disciplinaDtoAlteradoVindoDoBanco.ID);
		...
		public void DeveListarTodasDisciplinas()
		{
			...
			var disciplinasObtidas = this._disciplinaController.ObterTodos().Value as List<ObterDisciplinaDto>;

...
{
	public class CursoControllerTestes : TesteApi
	{
		...
		public CursoControllerTestes()
		{
			...
			this._cursoController = new CursoController(this._cursoServico);
		...
		public void DeveCriarCursoObterExcluirVerificar()
		{
			...
			this._cursoController.CriarCurso(cursoDto);
			...
			var cursoObtidoPorId = this._cursoController.ObterPorId(cursoObtidoPorNome.ID).Value as ObterCursoDto;
			...
			this._cursoController.AlterarCurso(cursoObtidoPorId.ID, cursoDtoAlteracao);

			//obtém o Curso alterado do banco de dados
			var cursoDtoAlteradoVindoDoBanco = this._cursoController.ObterPorId(cursoObtidoPorNome.ID).Value as ObterCursoDto;
			...
			//Deleta Disciplina
			this._cursoController.ExcluirCurso(cursoDtoAlteradoVindoDoBanco.ID);
		...
		public void DeveListarTodosCursos()
		{
			...
			var cursosObtidos = this._cursoController.ObterTodos().Value as List<ObterCursoDto>;

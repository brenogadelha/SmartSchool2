...
namespace SmartSchool.Aplicacao.Alunos.Alterar.Validacao
{
	public class AlunoValidacaoRequestAlteracao : AbstractValidator<AlterarAlunoCommand>
	{		
		public AlunoValidacaoRequestAlteracao()
		{

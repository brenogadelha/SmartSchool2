...
{
	public class DisciplinaRepositorioTask : IRepositorioTask<Disciplina>
	{
		private readonly IUnidadeDeTrabalho _contexto;
		public DisciplinaRepositorioTask(IUnidadeDeTrabalho contextos) => this._contexto = contextos;
